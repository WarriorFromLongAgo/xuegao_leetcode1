package com.xuegao.数据结构与算法.redis.quicklist;

import java.util.*;

/**
 * <br/> @PackageName：com.xuegao.数据结构与算法.redis.quicklist
 * <br/> @ClassName：QuickList
 * <br/> @Description：
 * <br/> @author：xuegao
 * <br/> @date：2021/8/10 23:33
 */
public class MyQuickList<E> extends AbstractSequentialList<E> implements Deque<E>, Cloneable, java.io.Serializable {
    ...
    public MyQuickList(int nodeCapacity) {
        if (nodeCapacity <= 0) {
    ...
    public MyQuickList(Collection<? extends E> c) {
        this();
        addAll(c);
    }
