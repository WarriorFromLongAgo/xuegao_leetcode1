...
## 你说你优化过 SQL，怎么优化的说下。什么情况下sql会不走索引
...
127.0.0.1:6379> set str1 1
OK
127.0.0.1:6379> set str2 2
OK
127.0.0.1:6379> set st1r 1
OK
127.0.0.1:6379> set st3r 2
OK
127.0.0.1:6379> keys *
1) "str2"
2) "st3r"
...
3) "first"
4) "second"
127.0.0.1:6379> eval "return redis.call('set', 'foo', 'poo')" 0
OK
127.0.0.1:6379> get foo
"poo"
127.0.0.1:6379> eval "return redis.call('set', KEYS[1], 'XUEGAO')" 1 foooo
OK
127.0.0.1:6379> keys *
1) "foooo"
2) "2"
...
127.0.0.1:6379> scan 100 match key99* count 1000
1) "4860"
2)  1) "key9939"
    2) "key9934"
    3) "key9979"
